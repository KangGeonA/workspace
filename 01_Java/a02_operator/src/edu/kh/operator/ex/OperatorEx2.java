...
public class OperatorEx2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("감소 연산 테스트");
		int num4 = 99;
		System.out.println(num4--); //99 출력 후 98
		System.out.println(num4--); //98 출력 후 97
		System.out.println(num4--); //97 출력 후 96
		System.out.println(num4--); //96 출력 후 95
		System.out.println(num4--); //95 출력 후 94
		System.out.println(num4); //94
