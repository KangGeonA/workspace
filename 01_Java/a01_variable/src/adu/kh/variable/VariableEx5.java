...
public class VariableEx5 {
	...
	public static void main(String[] args) {
		...
		//상수는 정말 값을 바꿀 수 없을까?
		// CONSTANT_NUMBER = 100; 없음!
		
		//상수 활용하기
		
		Scanner sc = new Scanner(System.in); //스캐너 생성
		
		final int INIT = 1000; //초기값 1000지정
		...
		System.out.println("1 입력 시 user1 -> 500증가, user2 -> 500 감소  ");
		
		System.out.println("2 입력 시 user1 -> 500감소, user2 -> 500 증가  ");
		...
		// A = B  (대입연산자 : B를 A에 대입)
		// A == B (비교연산자 : A와 B과 같다면 true, 아니면 false)
